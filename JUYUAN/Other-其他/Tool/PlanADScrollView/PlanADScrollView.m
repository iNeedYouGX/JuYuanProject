...
-(UIPageControl *)pageControl{
    if (!_pageControl) {
        _pageControl = [[PlanPageControl alloc] initWithFrame:CGRectMake(self.frame.size.width*0.5, self.frame.size.height, self.frame.size.width*0.5, 20)];
        _pageControl.pageIndicatorTintColor = UIColorFromRGB(0xA8A9A4);
